...
export default function FacultyTeam() {
    ...
    const faculty = [
        ...
        { value: "Coordination Team", names: [{ value: "1. Prof. M. R. Khodaskar (IT)" },{ value: "2. Dr. S. V. Mundhe (FE)" },{value:"3. Prof. H. B. Mali (EnTC)"}]},
        { value: "Marketing", names: [{ value: "1. Prof. S. S. Narkhede" },{ value: "2. Dr. A. M. Bagade (IT)" },{ value: "3. Dr. S. S. Sonawane (COMP)" },{value:"4. Prof. G. S. Mundada (EnTC)"}]},
        { value: "Guest Invitation & hospitality", names: [{ value: "1. Dr. G. V. Kale (COMP)" },{ value: "2. Prof. M. R. Kale (E&TC)" },{ value: "3. Prof. A. N. Syyad (FE)" }]},
        { value: "International Project Entries", names: [{ value: "1. Dr. M. P. Turuk (E&TC)" }]},
        { value: "National / State Level / Publicity (All Zones)", names: [{ value: "1. Dr. Emmanuel M." }]},
        { value: "Local Publicity", names: [{ value: "1. Prof. H. B. Mali &  Prof. H. S. Thakar" },{ value: "2. Prof. S. S. Pande (IT)" },{ value: "3. Prof. M. N. Kakade (E&TC)" },{ value: "4. Prof. Y. A. Handge (COMP)" },{value:"5. Dr. P. A. Khadkikar (COMP)"},{value:"6. Prof. M. V. Mane (COMP)"}]},
        { value: "Publicity through social media and Campus Ambassador Coordination", names: [{ value: "1. Dr. J. B. Jagdale" },{ value: "2. Prof. P. S. Shahane (COMP)" }]},
        ...
        { value: "Program Committee in consultation with Concerned committees", names: [{ value: "1. Prof. S. D. Hade (FE)" },{ value: "3. Dr. K. C. Waghmare (COMP)" },{ value: "3. Dr. U. R. Polina (FE)" }]},
        ...
        { value: "Stage Setup", names: [{ value: "1. Prof. P. S. Joshi (COMP)" },{value:"2. Prof. S. M. Hosamani (E&TC)"},{value:"3. Prof. U. S. Pawar (COMP)"},{value:"4. Prof. A. C. Karve (IT)"},{value:"5. Prof. A. C. Karve (IT)"},{value:"6. Prof. R. J. Sutar (E&TC)"},{value:"7. Prof. V. A. Patil (E&TC)"},{value:"11. Ms. A. M. Kulkarni (IT)"}]},
        ...
        { value: "Hardware", names: [{ value: "1. Prof. V. R. Jaiswal & Prof. N. V. Buradkar (IT)" },{ value: "2. Prof. D. M. Shinde (E&TC)" },{ value: "3. Prof. S. R. Warhade (IT)" },{value:"4. Mr. K. B. Kadambande (COMP)"},{value:"5. Mr. B.S. Jadhav (IT)"},{value:"6. Mr. D.P. Dabir (E&TC)"},{value:"7. Mr. A. V. Torne (FE)"},{value:"And all lab assistants"}]},
        ...
        { value: "Transport Management", names: [{ value: "1. Prof. P. D Jadhav & Mr. A. V. Sapkal" },{ value: "2. Prof. H. S. Khatri (FE)" },{ value: "3. Prof. V. R. Bhoi (FE)" },{value:"4. Prof. V. R. Bhoi (FE)"},{value:"5. Prof. A. S. Ramteke (FE)"},{value:"6. Mr. R. V. Badekar (COMP)"},{value:"7. Mr. A. B. Wagh (Purchase)"}]},
        ...
        { value: "TechFiesta - Event Execution", names: [{ value: "1. Prof. S.N Upasani & Prof M.R Jansari" },{ value: "2. Prof. P.B. Tathe (E&TC)" },{ value: "3. Prof. A. C. Karve (IT)" },{ value: "4. Mr. H.V Kasar (COMP)" },{ value: "5. Mr. M.K. Shegaonkar (IT)" },{ value: "6. Mr. L. M. Pawal (E&TC)" }]},
    ];
    return (
