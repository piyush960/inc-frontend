...
export default function FacultyTeam() {
    ...
    const faculty = [
        ...
        { value: "Transport Management", names: [{ value: "1. Prof. P. D Jadhav & Mr. A. V. Sapkal" },{ value: "2. Prof. H. S. Khatri (FE)" },{ value: "3. Prof. V. R. Bhoi (FE)" },{value:"4. Prof. A. S. Ramteke (FE)"},{value:"5. Mr. R. V. Badekar (COMP)"},{value:"6. Mr. A. B. Wagh (Purchase)"}]},
