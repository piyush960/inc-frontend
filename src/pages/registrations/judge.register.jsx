            ...
            <div className='mx-10 my-7 md:mx-20 placeholder:'>
                <form onSubmit={handleSubmit} className='shadow-md shadow-light_blue/20 bg-light_blue/30 rounded-xl items-center p-4 md:p-8 border border-light_blue w-full'>
                    ...
                    <>
                        ...
                        <InputBox label='Residential Address' type='text' name='residential_address' value={judge.residential_address} placeholder='Enter Residential Address' onChange={handleInputChange} error={errors.commercial_address} />
                        <InputBox label='Commercial Address' type='text' name='commercial_address' value={judge.commercial_address} placeholder='Enter Commercial Address' onChange={handleInputChange} error={errors.commercial_address} required />
