          ...
          <>
            ...
            {data?.data["concepts"]?.length > 0 &&
              data?.data["concepts"]?.map((project) => (
                <div
                  key={project.pid}
                  className="rounded-lg outline-dashed outline-2 outline-offset-[3px] my-2 outline-light_blue px-4 py-2 bg-faint_blue/10 mb-3 w-[100%] md:w-[100%]"
                >
                  <div className="flex ">
            ...
            {data?.data["impetus"]?.length > 0 &&
              data?.data["impetus"].map((project) => (
                <div
                  key={project.pid}
                  className="rounded-lg outline-dashed outline-2 outline-offset-[3px] my-2 outline-light_blue px-4 py-2 bg-faint_blue/10 mb-3 w-[90%] md:w-[90%]"
                >
                  <div className="flex ">
