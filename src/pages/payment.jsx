...
function Payment() {
  return (
    <div className="md:m-20 text-center">
      ...
      {/* <hr className='w-1/5 mx-auto' /> */}
      <div className="payment-container grid grid-cols-2 justify-items-center border border-dashed rounded-md px-10 mt-4 p-6">
        ...
        <div className="mt-6">
          ...
          <p className="text-gold text-2xl text-bold">Recipt ID:98626171338</p>
        </div>
