...
function Schedule() {
  return (
    <div id='schedule' className='md:m-20 p-2 flex flex-col justify-evenly items-stretch'>
          ...
          {/* <ol class='items-center sm:flex'> */}
            {/* <li class='relative mb-6 sm:mb-0 w-full'> */}
              ...
              <div class='mt-3  sm:pr-8'>
                ...
                <p class='block text-xl font-normal leading-none text-gold dark:text-gold py-1'> 🔷9:30 AM – Reporting to Shamiyana</p>
                <p class='block text-xl font-normal leading-none text-gold dark:text-gold py-1'> 🔷10:00 AM to 11:30 AM-Inauguration</p>
                <p class='block text-xl font-normal leading-none text-gold dark:text-gold py-1'> 🔷11:30 AM to 6:00 PM – Judging & Commencement of Exhibition.</p>
            ...
            <li class='relative mb-6 sm:mb-0 w-full'> */}
              ...
              <div class='mt-3 sm:pr-8'>
                ...
                {/* <p class='text-base font-normal text-white dark:text-white'>Get started with dozens of web components and interactive elements.</p> */}
                <p class='block text-xl font-normal leading-none text-gold dark:text-gold py-1'>🔷9:00 AM to 6:00 PM - Judging/Exhibition</p>
              </div>
            {/* </li>
            <li class='relative mb-6 sm:mb-0 '> */}
              ...
              <div class='mt-3 sm:pr-8 '>
                ...
                <p class='block text-xl font-normal leading-none text-gold dark:text-gold py-1'>🔷9:00 AM to 11:30 AM – Judging (if any projects left for judging)</p>
                <p class='block text-xl font-normal leading-none text-gold dark:text-gold py-1'>🔷11:30 AM to 4:30 PM – Evaluation</p>
