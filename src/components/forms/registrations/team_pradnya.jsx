...
//                     </div>
//                   </>) :<>
//                   <h1 className="px-5 font-xl md:px-6 py-4 w-48 text-white font-semibold border border-transparent focus:outline-0 rounded-xl bg-faint_blue/30 transition-all duration-300 hover:text-gold hover:border-light_blue hover:bg-faint_blue/10 cursor-pointer" onClick={showQR}>SHOW QR CODE
//                   </h1>

//                   <div className="my-6 shadow-md shadow-light_blue/20 bg-light_blue/30 rounded-xl  items-center p-4 md:p-8 border border-light_blue w-full">
//                     {/* <NoteBox
//                       title="Note"
//                       text="Please complete the payment within 60 minutes before your session expires. Don't refresh the window or close the tab."
//                     /> */}
...
//                       className="tracking-widest mt-6"
//                       required
//                     />
//                   </div>
...
//                   {showPaymentQR ? (
//                     <Modals modalState={true}>
//                       <div className="absolute left-0 top-0 z-50 bg-black bg-opacity-70 p-8 w-[100%] h-[100%] flex justify-center items-center">
//                         <div className="flex flex-col justify-center items-center bg-light_blue p-6 rounded-xl">
//                           <div className="flex justify-between items-center w-full mb-4">
//                             <h1 className="text-xl font-bold text-white">Scan the QR to pay</h1>
//                             <div className="relative w-10 h-10 bg-white p-2 rounded-full cursor-pointer" onClick={showQR}>
//                               <CloseIcon />
//                             </div>
//                           </div>
