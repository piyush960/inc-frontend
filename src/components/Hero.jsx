...
const Hero = () => {
  return (
    <section className='relative w-full h-screen mx-auto'>
      <p className={`${styles.paddingX} lg:text-[30px] sm:text-[26px] xs:text-[20px] text-[16px] lg:leading-[40px] absolute inset-0 mx-auto top-[20%] sm:top-[100px] w-full max-w-7xl text-center font-light uppercase text-secondary tracking-wide`}>SCTR's Pune Institute of Computer Technology</p>
      <div className='absolute mx-auto inset-0 w-full max-w-6xl h-screen flex flex-col items-center justify-center max-sm:top-[19%] '>
        ...
        <FlipWords
          ...
          className={`absolute sm:hidden top-[55%] text-lg ml-2 font-bold uppercase`}
        />
      </div>
      <EarthCanvas />
    </section>
