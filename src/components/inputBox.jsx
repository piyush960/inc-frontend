    ...
    return (
        <div className='input-box w-full mb-4 relative'>
            ...
            <input
                ...
                className={`input w-full bg-faint_blue/30 font-gilroy text-gold text-lg px-4 py-2 outline-0 border-1 border-transparent rounded-xl hover:border-light_blue focus:border-transparent focus:ring-1 focus:ring-light_blue focus:bg-faint_blue/20 ${props.classNames}`}
                autoComplete='off'
                {...props}
            />
